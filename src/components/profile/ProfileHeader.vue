...
<style scoped>
.profile-header{position:absolute;top:0;left:0;width:430px;height:260px;background:#56657E;border-radius:35px;overflow:hidden;color:#fff}.avatar{position:absolute;top:92px;left:calc(50% - 40px);width:80px;height:80px;border-radius:50%}.profile-title{position:absolute;top:60px;left:calc(50% - 33px);font-size:20px;font-weight:700}.greeting{position:absolute;top:168px;left:calc(50% - 43px);font-size:18px;font-weight:700}.notification{position:absolute;top:168px;left:376px;width:25px;height:26px}.bell{position:absolute;top:168px;left:30px;width:25px;height:25px}.bell-icon{position:absolute;top:0;left:0;width:20.7749px;height:19.7343px}.bell-tail{position:absolute;top:19.7343px;left:6.23px;width:8.31101px;height:5.26634px}.badge{position:absolute;top:-5px;right:-4px;width:18px;height:18px}.badge-count{position:absolute;top:-5px;right:-3px;width:16px;color:#fff;font-family:'Noto Sans TC',sans-serif;font-size:11px;font-weight:900;line-height:18px;text-align:center}
</style>
