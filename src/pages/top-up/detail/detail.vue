  ...
  <view class="page" :style="responsiveStyle">
    <view v-if="success" class="success-screen">
      <view class="success-header">
        <image class="success-back" src="/static/top-up/back.svg" mode="aspectFit" @tap="goBack" />
      </view>
