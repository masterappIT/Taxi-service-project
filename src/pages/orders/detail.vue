<template>
  <view class="page" :style="responsiveStyle">
    ...
    <template v-if="isTraveling">
      <view class="traveling-order-number">訂單編號：282678634</view>
      <view class="traveling-card">
        ...
        <view class="traveling-waiting"><view class="waiting-mark"><image src="/static/orders/traveling-wait-ring.svg" mode="aspectFit" /><image src="/static/orders/traveling-wait-dot.svg" mode="aspectFit" /></view><text>等待中</text></view>
...
import { closeCachedPage, cachedPageUrl } from '../../utils/navigation'
