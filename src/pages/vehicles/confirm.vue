<template>
  <view class="page" :style="responsiveStyle">
    ...
    <view class="summary-panel">
      ...
      <image class="coupon-info" src="/static/vehicles/coupon-info.svg" mode="aspectFit" />
