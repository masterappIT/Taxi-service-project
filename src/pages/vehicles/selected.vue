<template>
  <view class="page" :style="responsiveStyle">
    ...
    <view class="vehicle-card">
      <view class="toyota-mark"><image class="toyota-logo" src="/static/vehicles/toyota-logo.svg" mode="aspectFit" /><text class="vehicle-name">Toyota <strong>Alphard</strong></text><text class="series">30系</text></view>
      <image class="vehicle-image" src="/static/vehicles/alphard.png" mode="aspectFit" />
      <view class="seat-pill"><image src="/static/vehicles/seat.svg" mode="aspectFit" /><text>7座</text></view>
      <view class="color-pill">不限顏色</view>
      <view class="price-pill">RMB¥800</view>
      <text class="discount">已減 ¥200</text>
    </view>
