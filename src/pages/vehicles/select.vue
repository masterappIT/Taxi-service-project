  ...
  <view class="page" :style="responsiveStyle">
    ...
    <scroll-view class="vehicle-scroll" scroll-y :show-scrollbar="false">
      <view v-for="group in visibleGroups" :key="group.category" class="vehicle-group">
        ...
        <VehicleCard v-for="vehicle in group.vehicles" :key="`${group.category}-${vehicle.id}`" :vehicle="vehicle" :selectable="vehicle.selectable" :selected="selectedVehicleId === vehicle.id" @select="selectVehicle(vehicle)" />
