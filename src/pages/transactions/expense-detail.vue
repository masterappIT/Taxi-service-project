...
<style scoped>
:global(html),:global(body),:global(#app){width:100%;height:100%;margin:0;overflow:hidden}.page{position:fixed;top:0;left:0;width:430px;height:932px;overflow:hidden;border-radius:35px;background:#f0f2f5;color:#38434a;font-family:'Noto Sans TC',sans-serif}.header{position:absolute;top:0;left:0;width:430px;height:110px;border-radius:25px;background:#fff}.back{position:absolute;top:60px;left:33px;width:12px;height:25px}.action{position:absolute;top:60px;left:336px;width:87px;height:32px}.success-icon{position:absolute;top:160px;left:165px;width:100px;height:100px}.title{position:absolute;top:270px;left:calc(50% - 100px);font-size:18px;white-space:nowrap}.amount{position:absolute;top:306px;left:136px;height:43px;display:flex;align-items:flex-end}.currency{align-self:flex-end;margin-bottom:8px;line-height:18px;font-size:14px;font-weight:500}.yen{margin-left:1px;font-size:26px;font-weight:500;line-height:normal}.number{margin-left:8px;font-size:30px;font-weight:700;line-height:normal}.status{position:absolute;top:359px;left:193px;display:flex;align-items:flex-end;gap:5px;color:#285cfc;font-size:12px;font-weight:500}.status image{width:15px;height:15px}.details{position:absolute;top:409px;left:15px;width:400px;height:354px;overflow:hidden;border-radius:10px;background:#fff}.section-title{position:absolute;top:20px;left:20px;font-size:16px;font-weight:350}.payment-card{position:absolute;top:53px;left:10px;width:380px;height:50px;display:flex;align-items:center;justify-content:space-between;padding:10px;box-sizing:border-box;border:1px solid #285cfc;border-radius:10px;box-shadow:0 4px 4px rgba(0,0,0,.25)}.payment-copy{display:flex;align-items:center;gap:16px;color:#1d2939;font-family:Inter,sans-serif;font-size:14px;white-space:nowrap}.payment-copy>view{display:flex;flex-direction:column;gap:4px}.card-icon{width:36px;height:24px}.wallet-icon{width:25px;height:25px}.muted,.allocation{color:#667085;font-size:12px}.selected{width:24px;height:24px}.wallet-card{top:118px}.order-total{position:absolute;top:188px;left:20px;width:361px;display:flex;justify-content:space-between;font-size:14px}.order-total text:last-child{color:#285cfc}.allocation{position:absolute;left:202px;display:flex;align-items:center;gap:5px;height:18px;font-family:Inter,sans-serif}.allocation image{width:15px;height:15px}.cash image{width:20px;height:13.333px}.allocation text:last-child{position:absolute;left:99px;width:80px;text-align:right;font-size:10px}.cash{top:213px}.fare{top:236px}.fare image{position:absolute;left:-1px;top:1px}.fare text:first-of-type{margin-left:20px}.order-link{position:absolute;top:274px;left:20px;width:358px;height:20px;display:flex;align-items:center;justify-content:space-between;font-size:14px}.order-link image{width:9px;height:15px}.success-time{position:absolute;top:314px;left:19px;width:361px;display:flex;justify-content:space-between;font-size:14px}.success-time text:last-child{font-size:14px}@media(max-width:599px){.page{height:var(--mobile-height,100dvh);transform:scale(var(--mobile-scale,1));transform-origin:top left}}
</style>
