...
class AdminController {
  ...
  @Get('recommended-addresses') listRecommendedAddresses(@Req() req: RequestLike) { requireAuth(req); return { data: [...recommendedAddresses].sort((a, b) => a.order - b.order), total: recommendedAddresses.length } }
...
@Module({ controllers: [HealthController, LocationController, SettingsController, RecommendedAddressesController, AdminAuthController, AdminController, SupportController] }) class AppModule {}
